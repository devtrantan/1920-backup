...
add_action( 'admin_enqueue_scripts', 'devtran_scripts' );

function devtran_scripts(){
	$version = time();

	//Load CSS for Admin
	wp_enqueue_style('main-style-css', THEME_URL . '-child' . '/assets/main/dashboard-custom.css', array(), $version, 'all');
}
